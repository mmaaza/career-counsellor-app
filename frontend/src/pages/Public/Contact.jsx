      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to take the next step in your career journey? I'm here to help you 
            achieve your professional goals. Let's start the conversation today.
          </p>
        </div>
      </section>
              ...
              {submitStatus === 'success' && (
                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <span className="text-green-800 font-medium">Message sent successfully! I'll get back to you within 24 hours.</span>
                  </div>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                    placeholder="Tell me about your career goals, challenges, or any questions you have..."
                  />
                </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8">
                ...
                <p className="text-gray-600">
                  Located in the heart of New York City, offering both virtual and in-person sessions. 
                  Convenient access to public transportation and parking available.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8">
                ...
                <div className="space-y-4">
                  ...
                  <button 
                    ...
                    className="w-full border border-blue-600 text-blue-600 hover:bg-blue-50 font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center"
                  >
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    ...
                    className="w-full border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center"
                  >
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Common questions about career counseling and my services
            </p>
          </div>
